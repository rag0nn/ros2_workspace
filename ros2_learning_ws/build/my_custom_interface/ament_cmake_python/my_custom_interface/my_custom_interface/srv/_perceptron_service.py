...
class PerceptronService_Request(metaclass=Metaclass_PerceptronService_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.inputs = array.array('q', kwargs.get('inputs', []))
    ...
    def inputs(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'inputs' array.array() must have the type code of 'q'"
            self._inputs = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'inputs' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._inputs = array.array('q', value)
