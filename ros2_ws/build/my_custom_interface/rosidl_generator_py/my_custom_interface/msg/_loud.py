...
class Metaclass_Loud(type):
    """Metaclass of message 'Loud'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_custom_interface.msg.Loud')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__loud
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__loud
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__loud
            cls._TYPE_SUPPORT = module.type_support_msg__msg__loud
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__loud
...
class Loud(metaclass=Metaclass_Loud):
    """Message class 'Loud'."""
    ...
    def channel(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'channel' field must be an integer in [-32768, 32767]"
        self._channel = value
